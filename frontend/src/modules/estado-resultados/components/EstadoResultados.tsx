      ...
      <div className="mb-8 print:hidden">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-slate-500">Resumen financiero — ingresos, costos, gastos y utilidad.</p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-4 py-2 border border-slate-200 bg-white text-slate-700 font-semibold rounded-lg hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm text-sm"
            >
